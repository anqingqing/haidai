...
<template>
  <div class="container">
          ...
          <span class="toptitle">{{skincare.name}}</span>
      </div>

	    <img class="big_img" :src="skincare.big_img" alt="">
	    <div class="footer_box">
	        <div class="box1">
	          <div class="people">
	              <div class="icon_img">
	                <img :src="skincare.icon_header" alt="" class="head_icon">
	              </div>
	              <div class="icon_name">
	                <span class="name">{{skincare.name}}</span>
	              </div>
	          </div>
		...
		<p class="content">{{skincare.content}}</p>
...
export default {
  ...
  created:function(){
    ...
    // console.log(id);
    // console.log(Data);
    this.skincare = Data.skincare[id];
