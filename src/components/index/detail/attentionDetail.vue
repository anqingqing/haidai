  ...
  <div class="container">
      ...
      <div class="detailnav">
        <span onclick="window.history.go(-1)">
          ...
          <span class="toptitle">{{guanzhu.title}}</span>
      </div>

	    <img class="big_img" :src="guanzhu.img" alt="">
	    <div class="footer_box">
	        <div class="box1">
	          <div class="people">
	              <div class="icon_img">
	                <img :src="guanzhu.icon_header" alt="" class="head_icon">
	              </div>
	              <div class="icon_name">
	                <span class="name">{{guanzhu.name}}</span>
	              </div>
	          </div>
		...
		<p class="content">{{guanzhu.content}}</p>
